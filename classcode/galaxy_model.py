...
class model_galaxy(object):
    ...
    def dMsdt(self, Mcurrent, t):
        dummy = self.Ms_in(t) + self.Rloss1*self.SFR(t)
        return dummy
    ...
    def dMgdt(self, Mcurrent, t):
        dummy = self.Mg_in(t) - (self.Rloss1 + self.eps_out())*self.SFR(t)
        return dummy
    ...
    def dMZdt(self, Mcurrent, t):
        dummy = self.Z_IGM*self.Mg_in(t) + (self.yZ*self.Rloss1*(1.-self.zeta()) - (self.Rloss1+self.eps_out())*self.MZ/(self.Mg))*self.SFR(t)
        return dummy
